    ...
    <div class="dp-hero">
        ...
        <div class="dp-hero-content">
            <div class="dp-hero-text">
                ...
                <h2 class="dp-hero-title">DropPilot kontrol merkezine hoşgeldin</h2>
                <p class="dp-hero-subtitle">
                    Shopify mağazalarını PlentyMarkets B2B müşterilerine eşle, sipariş akışını otomatikleştir, kataloğu tek tıkla aktar.
                </p>
